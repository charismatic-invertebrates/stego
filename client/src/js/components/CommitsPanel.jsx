    ...
    return (
      <div className="panel-container">
        ...
        <div className="panel commits-panel" ref="commitsPanel">
          ...
          <CommitsOverTime auth={this.props.auth} user={this.props.user} parentId="commits-over-time" currentValue={this.props.user.github.totalCommits} max={this.props.max} />
        </div>
      </div>
    );
  }
